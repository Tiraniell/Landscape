...
public class Window : EditorWindow
{
    ...
    void OnGUI()
    {
        GO = EditorGUILayout.ObjectField("Меш обьекта", GO, typeof(MeshRenderer), true) as MeshRenderer;
        newMat = EditorGUILayout.ObjectField("Материал обьекта", GO, typeof(Material), true) as Material;
